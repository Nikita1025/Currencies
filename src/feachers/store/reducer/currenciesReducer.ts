...
export const currenciesReducer = (state = initialState, action: ActionType): InitialStateType[] => {
    switch (action.type) {
        case 'GET-DATA': {
...
export const getDataAC = (data: InitialStateType[]) => ({type: 'GET-DATA', data} as const)
